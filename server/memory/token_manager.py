    ...
    def _save_model_with_tokens(self):
        ...
        try:
            ...
            if os.path.exists(config_path):
                ...
                token_added_model_dir = config.get("memory", {}).get("training", {}).get("token_added_model_dir", "./server/models/token_added")
            else:
                token_added_model_dir = "./server/models/token_added"
